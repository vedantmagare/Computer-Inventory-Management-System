...
Public Class rptcustbill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Computer_Inventory_Management_System.rptcustbill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcustbill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcustbill = New rptcustbill()
        rpt.Site = Me.Site
        Return rpt
    End Function
