...
Public Class Frmcustbill
    Dim con As OleDbConnection
    Dim dtcustorder As DataTable
    Dim DTCoBill As DataTable
    Dim DTCustOrderDetails As DataTable
    Dim cmd As OleDbCommand
    Dim rate As Double

    Private Sub Frmcustbill_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            dtcustorder = New DataTable("custbill")
            ...
            Dim selectPackageBookingInfo As String = "SELECT * FROM custbill order by billid"
            ...
            Cmbcoid.DataBindings.Add("SelectedValue", DTCoBill, "coid")
    ...
    Private Sub cmbcoid_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmbcoid.SelectedIndexChanged
        ...
        Try
            If Cmbcoid.Text <> "" Then
                If con.State = ConnectionState.Closed Then
                    con.Open()
                End If
                Dim selectCoBill As String = "SELECT price,qty FROM custorderdetails, item where item.iid=custorderdetails.iid and coid=" & Cmbcoid.SelectedValue
    ...
    Private Function IsValidForm() As Boolean
        If Cmbcoid.Text = "" Then
            MsgBox("Please select customer order id")
            Cmbcoid.Focus()
            Return False
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Dim str As String
        Try
            str = "INSERT into custbill(coid, amt, tax, famt, bdate) VALUES (" & Cmbcoid.SelectedValue & "," & CType(Txtamt.Text, Decimal) & "," & CType(Txttax.Text, Decimal) & "," & CType(Txtfamt.Text, Decimal) & ",'" & DateTimePicker1.Value & "')"
            con.Open()
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            str = "UPDATE custbill SET billid = " & Cmbcoid.SelectedValue & ",amt = " & CType(Txtamt.Text, Decimal) & " ,tax = " & CType(Txttax.Text, Decimal) & " ,famt= " & CType(Txtfamt.Text, Decimal) & ",bdate = '" & DateTimePicker1.Value & "' WHERE custbill = " & DTCoBill.Rows(Me.BindingContext(DTCoBill).Position)("billid")
            con.Open()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDelete.Click
        ...
        Try
            ...
            If MsgBox("Are you sure you want to delete selected record?", vbYesNo + vbCritical) = vbNo Then
                Exit Sub
            End If
            str = "DELETE FROM custbill WHERE billid = " & DTCoBill.Rows(Me.BindingContext(DTCoBill).Position)("billid")
            con.Open()
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Dim pbill As New rptcustomer2(DTCoBill.Rows(Me.BindingContext(DTCoBill).Position)("billid"))
        pbill.Show()
    End Sub
End Class